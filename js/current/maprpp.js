...
function DC(v) {
	getObj('Stuff2').innerHTML = '<b>' + Infos[v].i + '</b><br>Level: ' + Infos[v].v + '<br><' + strClicky2 + ' onclick="if (Processing ==0) {Processing = 1; window.location.replace(\'mapr.asp?Type=' + Type2 + '&StartX=' + x + '&StartY=' + y + '&StartZ=' + z + '&Pet=' + Infos[v].value + '\')}" style=\'width: 85\'>Select</button>';
