...
document.write('<td id="IP' + IC + '"><img id="I' + IC + '" src=\'https://res.landsofhope.com/images/scratch5.gif\' style=\'cursor: pointer; background-image:URL(https://res.landsofhope.com/game/' + Picture + ');\' title=\'Scratch me!\' onclick=\'Scratch(' + IC + ')\'></td>');
count = count + 1
if (count == 5) {
	document.write('</tr>');
	count = 1;
