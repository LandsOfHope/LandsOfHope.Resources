...
document.write('<tr id="I' + IC + '" onmouseover="PC(' + IC + ')" onmouseout="RC(' + IC + ')" onclick="DC(' + IC + ')" style="color: ' +  Color + '"><td width=360><table width=360 class="weakercell" cellpadding=0 cellspacing=0><tr><td rowspan=2><img width=30 height=30 src="' + (IPath + rpp + '/' + PictureID) + '"></td><td><b>' + rn + (rq > 1 ? ' * ' + rq : '') + '</b></td></tr><tr><td><table class="weakercell" width=320 cellpadding=0 cellspacing=0><td width=90>Fame: ' + rf + '</td><td width=180>' + window.top.BSGM3(rc) + '</td><td width=90>Level: ' + rl + '</td></tr></table></td></tr></table></td></tr>');
IC = IC + 1;
}
