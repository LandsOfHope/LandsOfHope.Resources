...
document.write('<tr id="T' + TC + '" style="color:' + Color +'" onclick="DC(' + TC + ')" onmouseover="PC(' + TC + ');" onmouseout="RC(this)"><td width="40"><img src="https://res.landsofhope.com/game/i/' + tip + '"></td><td width="260" valign=top><b>' + tin + '</b><br>' + tpt + '</td><td>' + tpc + '</td></tr>');
TC = TC + 1;
