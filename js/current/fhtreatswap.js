...
function DC(v) {
getObj('Stuff2').innerHTML = '<b>' + Infos[v].i + '</b><br>Level: ' + Infos[v].v + '<br>' + Adr('if (Processing ==0) {Processing = 1; window.location.replace(\'fhtreatswap.asp?InventoryItemID=' + InventoryItemID + '&CharsAt=' + Infos[v].value + '\');}','Give to ' + Infos[v].i ,'Give');
