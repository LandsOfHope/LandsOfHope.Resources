...
function DC(v) {
	...
	getObj('Buttons').innerHTML = '' + (Processing == 0 ? Adr('if (Processing == 0) {Processing = 1; window.location.replace(\'fhppost2.asp?CharsAt=' + CharsAt + '&Special=0&ItemID=' + Infos[v].value + '\');}', 'Parrot Post', 'Parrot Post') + Adr('window.top.loadwindow2(\'im4.asp?Test=' + Infos[v].value + '&Bonus=0&Material=\',300,300,\'iwindow\',\'' + Infos[v].t + '\');', 'Info', 'Info') : '');
}
