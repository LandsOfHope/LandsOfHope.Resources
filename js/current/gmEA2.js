...
function DC(v) {
	...
	getObj('Buttons').innerHTML = Adr('window.location.replace(\'/gm/gmEA.asp?Mask=' + Mask + '&CharsAt=' + Infos[v].d + '\');', 'Account', 'Account') + Adr('window.location.replace(\'/gm/gmEA2.asp?Mask=' + Mask + '&CharsAt=' + Infos[v].d + '\');', 'Billing', 'Billing') + Adr('conf(\'Type of Account: (100=Staff 99=Cancelled/Postal 0=f2p -100=Courtesy 2=monthly p2p(PayPal), 3=yearly p2p(PayPal)).\', \'' + Infos[v].o + '\', \'/gm/gmEA2.asp?Mask=' + Mask + '&Action=11&CharsAt=' + Infos[v].d + '&Name=\');', 'Type', 'Type') + Adr('conf(\'Hope Credits Balance:\', \'' + Infos[v].dd + '\', \'/gm/gmEA2.asp?Mask=' + Mask + '&Action=14&CharsAt=' + Infos[v].d + '&Name=\');', 'HC', 'HC') + Adr('gowin(\'/gm/gmEAN.asp?CharsAt=' + Infos[v].d + '\', 615, 200,50, \'Notices\')', 'Notices', 'Notices') + (Infos[v].b != 0 ? Adr('conf(\'Please enter an optional note with regards the cancellation of the ban.\', \'Ban lifted by ' + CharacterName + '\', \'/gm/gmEA2.asp?Mask=' + Mask + '&Action=12&CharsAt=' + Infos[v].d + '&Name=\');', 'Unban', 'Unban') : Adr('conf(\'Please enter a reason for this ban.\', \'Generic Violation\', \'/gm/gmEA2.asp?Mask=' + Mask + '&Action=13&CharsAt=' + Infos[v].d + '&Name=\');', 'Ban', 'Ban'));
}
