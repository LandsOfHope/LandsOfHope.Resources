...
function GetAbilities(f) {
	...
	if (Fighters[f].s == Side && f == 0) {
		retVal = `${retVal}<div class="btn" onclick="FAC(${f}, -10)" style="float: left; width: 34px; height: 40px; background-image: URL(${CDN_RESOURCES_URL}/game/icons/lightning.png); background-repeat: no-repeat; background-position: center center;" title="Ask for your Gods Favor" onmouseover="PC3(this, 'Ask for your Gods Favor')" onmouseout="RC2(this)" align=bottom>&nbsp;</div>`;
		retVal = `${retVal}<div class="btn" onclick="FAC(${f}, -20)" style="float: left; width: 34px; height: 40px; background-image: URL(${CDN_RESOURCES_URL}/game/icons/star.png); background-repeat: no-repeat; background-position: center center;" title="Entertain" onmouseover="PC3(this, 'Entertain')" onmouseout="RC2(this)" align=bottom>&nbsp;</div>`;
