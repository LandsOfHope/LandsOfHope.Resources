...
function DC(v) {
	...
	getObj('Buttons').innerHTML = Adr('getObj(\'Message\').value = tinyMCE.get(\'Message\').getContent();getObj(\'Resp\').submit();', 'Save changes', 'Save') + Adr('window.top.SendCommand(tinyMCE.get(\'Message\').getContent());', 'Preview text', 'Preview');
	//OtherStuff();
