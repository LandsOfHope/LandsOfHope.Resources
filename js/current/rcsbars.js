...
const CDN_RESOURCES_URL_rcsbars = new URL(document.currentScript.src).origin;
...
function RCSSMOver(b, x) {
	...
	if (bb != null) {
		...
		if (bb2 != null) {
			bb2.innerHTML = `<img src='${CDN_RESOURCES_URL_rcsbars}/images/circle6.png' width=12 height=12>`
		}
		bb2 = null;
...
function RCSSMOut(b, x) {
	...
	if (bb != null) {
		...
		var bb2 = getObj('prcssm' + x);
		if (bb2 != null) {
			bb2.innerHTML = `<img src='${CDN_RESOURCES_URL_rcsbars}/images/circle0a.png' width=12 height=12>`
		}
		bb2 = null;
	}
}
...
function RCSSMClick(b, x) {
	...
	if (bb != null) {
		...
		var bb2 = getObj('prcssm' + x);
		if (bb2 != null) {
			bb2.innerHTML = `<img src='${CDN_RESOURCES_URL_rcsbars}/images/circle3.png' width=12 height=12>`;
		}
		bb2 = null;
	}
}
