...
function XYBox(xc, yc) {
	if (window.top.Jailed != 0) {
		window.top.getObj("Map3").innerHTML = "<table width=420 cellpadding=0 cellspacing=0 class='weakercell'><tr><td align=left>" + ASCII("Jailed", 1) + "</td><td style='background-image: URL(https://res.landsofhope.com/game/icons/bar_tab3.png); width: 80px; text-align: center;font-weight: bold; cursor: pointer;' onclick='RefreshWindow();' title='Refresh Game Window'>" + ASCII("Refresh", 2) + "</td><td id=actionlist style='background-image: URL(https://res.landsofhope.com/game/icons/bar_tab3.png); width: 120px; text-align: center;font-weight: bold; cursor: pointer;' title='World Action Choices' onclick='ActionList();'>" + ASCII("World Actions", 6) + "</td><td id=OptionCog style='background-image: URL(https://res.landsofhope.com/game/icons/bar_tab3.png); width: 20px; text-align: center;font-weight: bold; cursor: pointer;' onclick='OptionCogMenu();' title='Option Menu'><img src='https://res.landsofhope.com/game/icons/cog.png'></td></tr></table></form>"
	} else if (xc == 0 && yc == 0) {
