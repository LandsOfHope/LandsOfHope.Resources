...
function AC(IID, ItemName, PictureID, ip, wl, wq, wp, wpp, price, wd, fund, wi2, wn2) {
...
function PC(v) {
	window.top.InfoTip(IPath + Infos[v].ip + (Infos[v].p == '' ? 'na.gif' : Infos[v].p), Infos[v].i + (Infos[v].wi2 != 0 ? '<br>Payment: ' + Infos[v].wn2 : '<br>Quantity: ' + Infos[v].wq + '<br>Level: ' + (Infos[v].wl < 0 ? 'any' : '' + Infos[v].wl) + '<br>Price: ' + window.top.BSGM2(Infos[v].price)) + '');
