...
document.write('<tr style="cursor: pointer; color: ' +  Color + '; background-color: ' + BColor + '; padding-left: 5px"><td width=\'300\' valign=top><b>' + ItemName + '</b>' + '</td><td width=\'120\' valign=top>' + (at == 0 ? 'Buying ' : 'Selling ') + '<b>' + mv + '</b>HC</td><td id=\'tgold\' width=\'90\' valign=top>' + window.top.BSGM(mp) + '</td><td>' + (yp == 1 ? '<img src="https://res.landsofhope.com/game/icons/comment_delete.png" title="Delete" style="cursor: pointer;" class="xbtn" onclick="javascript:window.location.replace(\'?SN=' + SN + '&Type2=2&Type3=' + IID + '&P=' + PageNo + '\');">' : '<img src="https://res.landsofhope.com/game/icons/arrow_redo.png" title="Complete" style="cursor: pointer;" class="xbtn" onclick="javascript:confirm(\'Are you sure you wish to complete this job?\', ' + IID + ');">') + '</td></tr>');
}
