...
function Getmymenu(lm, v) {
	...
	tmp = (lm == null ? '<table cellspacing=0 style="font-size: 10px; cursor: pointer;" cellpadding=0 ' + (verticalmenu != 0 ? 'width="170px"' : '') + '><tr style="height: 2px"><td style="height: 2px" colspan="27" onmouseover="HM3(0,0,0);"></td></tr><tr>' : '') + (lm == null && v == 0 ? '<td width=10 onmouseover="HM3(0,0,0);" style="border: 1px dotted ' + COLOR1_S + '">&nbsp;</td>' : '');
	for (x = 1; x < mymenu.length; x++) {
