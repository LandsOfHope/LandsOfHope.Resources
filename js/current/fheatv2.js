...
function TickDone() {
	TickOff();
	window.location.replace('?InventoryItemID=' + IID + '&il=' + IIL + '&ItemID=1&Tick=' + Tick + '&CharsAt=' + CharsAt);
}