...
function DC(v) {
	...
	getObj('Buttons').innerHTML = '<' + strClicky2 + ' onclick="window.location.replace(\'?ItemTypeID=' + ItemTypeID + '&P=' + PageNo + '&ItemID=1&InventoryItemID=' + Itemz[v].z + '\');" style=\'width: 85\'>Cancel</button>' + (Itemz[v].a != 0 ? '<' + strClicky3 + ' onclick="window.open(\'https://www.paypal.com/xclick/business=billing%40fho2.com&no_shipping=1&item_name=Item Rename&item_number=49&amount=5&custom=' + Itemz[v].z + '&no_note=1\', \'PP\', \'\');">Buy for $5</button><' + strClicky3 + ' onclick="window.open(\'fhfhd.asp?item_name=Item Rename&item_number=49&a3=1&custom=' + Itemz[v].z + '\', \'PP\', \'\');">Buy for 1hc</button>' : '');
}
