...
document.write('<tr id="I' + IC + '" title=\'Click to select ' + ItemName + '.\' onmouseover="MO(' + IC + ');" onmouseout="MT(' + IC + ');" onclick="DC(event, ' + IC + ')" style="width: 100%; cursor: pointer; color: ' +  Color + '; padding-left: 5px;"><td width=15><img src=\'' + IPath + (PictureID == '' ? 'na.gif' : PictureID) + '\' width=15 height=15></td><td width=\'100%\' style=\'' + (il > Level || at > AT ? 'border: 1px dotted red' : '') + '\'>' + ItemName + '</td><td>' + GetATS(at, d) + '</td></tr>');
IC = IC + 1;
}
...
document.write('<tr id="I' + IC + '" title=\'Click to select ' + ItemName + '.\' onmouseover="MO(' + IC + ');" onmouseout="MT(' + IC + ');" onclick="DD(event, ' + IC + ')" style="width: 100%; cursor: pointer; color: ' +  Color + '; padding-left: 5px;"><td width=15><img src=\'' + IPath + (PictureID == '' ? 'na.gif' : PictureID) + '\' width=15 height=15></td><td width=\'100%\' style=\'' + (il > Level || at > AT ? 'border: 1px dotted red' : '') + '\'>' + ItemName + '</td><td>' + GetATS(at, d) + '</td></tr>');
IC = IC + 1;
}
