...
document.write(`<script src="${CDN_RESOURCES_URL}/js/current/simpleformatting.js" language="JavaScript"></script>`);
...
function NewChar(x) {
	if (getObj('ControlButtons') == null) {
		...
		getObj('ControlButtons').innerHTML = `<img onclick="Login()" style=\'cursor: pointer;\' src="${CDN_RESOURCES_URL}/images/play2.png" title=\'Play the selected character\'><img onclick="Login2()" style=\'cursor: pointer;\' title=\'Play using safe mode - chat and some other features disabled by default.\' src="${CDN_RESOURCES_URL}/images/safemode.png"><img onclick="DelChar();" style=\'cursor: pointer;\' src="${CDN_RESOURCES_URL}/images/delete.png">`;
		if (x > 0) {
			getObj('Special').innerHTML = `<table width="280"><tr><td colspan=4>${x} slots remaining</td></tr><tr><td><img onclick="DC3();" title=\'Create a new character\' style=\'cursor: pointer;\' src="${CDN_RESOURCES_URL}/images/newcharacter.png"></td><td><img  src="${CDN_RESOURCES_URL}/images/newgladiator.png" onclick="DC5();" title=\'Create a new Gladiator character\' style=\'cursor: pointer;\'></td>${estring.indexOf('P') != -1 ? `<td><img onclick="DC4();" title=\'Create a new pirate\' style=\'cursor: pointer;\' src="${CDN_RESOURCES_URL}/images/newpirate.png"></td>` : ''}</tr></table>`;
		}
	}
}
