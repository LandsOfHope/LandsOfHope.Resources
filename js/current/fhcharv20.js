...
function NewChar(x) {
	if (getObj('ControlButtons') == null) {
		...
		getObj('ControlButtons').innerHTML = '<img onclick="Login()" style=\'cursor: pointer;\' src="https://res.landsofhope.com/images/play2.png" title=\'Play the selected character\'><img onclick="Login2()" style=\'cursor: pointer;\' title=\'Play using safe mode - chat and some other features disabled by default.\' src="https://res.landsofhope.com/images/safemode.png"><img onclick="DelChar();" style=\'cursor: pointer;\' src="https://res.landsofhope.com/images/delete.png">';
		if (x > 0) {
			getObj('Special').innerHTML = '<table width="280"><tr><td colspan=4>' + x + ' slots remaining</td></tr><tr><td><img onclick="DC3();" title=\'Create a new character\' style=\'cursor: pointer;\' src="https://res.landsofhope.com/images/newcharacter.png"></td><td><img  src="https://res.landsofhope.com/images/newgladiator.png" onclick="DC5();" title=\'Create a new Gladiator character\' style=\'cursor: pointer;\'></td>' + (estring.indexOf('P') != -1 ? '<td><img onclick="DC4();" title=\'Create a new pirate\' style=\'cursor: pointer;\' src="https://res.landsofhope.com/images/newpirate.png"></td>' : '') + '</tr></table>';
		}
	}
}
