...
function PC(v) {
window.top.InfoTip('' + IPath + (Infos[v].p == '' ? 'na.gif' : Infos[v].p), ' <font color=' + Infos[v].c + '>' + Infos[v].i + '</font>' + (Infos[v].sn != '' ? '<br>' + Infos[v].sn : '') + '<br>Level: ' + Infos[v].l + (Infos[v].at > 0 ? '<br>Armor: ' + GetAT(Infos[v].at) : '') + '<br>Rarity: ' + Infos[v].q + '<br>Quantity: ' + Infos[v].q2 + '<br>Cost: ' + window.top.BSGM(Infos[v].v * (pmc <= 0 ? Math.floor(Infos[v].q2) : 1 )));
