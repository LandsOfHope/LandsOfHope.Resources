...
Infos[IC] = new newInfo(Color, pn, pv);
document.write('<tr id="I' + IC + '" onmouseover="PC(' + IC + ')" onmouseout="RC(' + IC + ')" onclick="DC(' + IC + ')" style="color: ' +  Color + '; padding-left: 5px;"><td width=15></td><td width=\'100%\'>' + pn + '</td><td>' + pv + '</td></tr>');
IC = IC + 1;
}

function newInfo(Color, pn, pv) {
this.c = Color;
this.pv = pv;
this.pn = pn;
}
