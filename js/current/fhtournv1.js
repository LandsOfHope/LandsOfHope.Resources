...
function DC(v) {
getObj('Stuff2').innerHTML = '<b>' + Infos[v].i + '</b><br>Race: ' + Infos[v].r + '<br>Profession: ' + Infos[v].n + '<br>Level: ' + Infos[v].l + '<br>Wins: ' + Infos[v].w + ' Losses: ' + Infos[v].lo + ' Draws: ' + Infos[v].d + '<br>Guild Fame Earnt: ' + Infos[v].m;
...
function AC(z,m, w, lo, d, v, r, n,l, PictureID, ItemName) {
...
Infos[IC] = new newInfo(Color, z,m, w, lo, d, v, r, n,l, PictureID, ItemName);
...
function newInfo(Color, z,m, w, lo, d, v, r, n,l, PictureID, ItemName) {
this.c = Color;
this.v = v;
this.p = PictureID;
this.i = ItemName;
