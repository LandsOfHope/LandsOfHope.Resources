...
function DrawVaults() {
	var x = 0;
	var strout = '';
	strout += '<td onclick=\'ShowVault(0);\' title=\'Main vault compartment\' style=\'cursor: pointer; border: 1px dotted gold; background-image: URL(https://res.landsofhope.com/game/i/bv1.gif); width: 26px; height: 58px; background-repeat: no-repeat; background-position: top middle;\' valign=bottom><b>0</b></td>';
	for (x = 1; x < 10; x++) {
		strout += '<td onclick=\'ShowVault(' + x + ');\' title=\'Vault compartment ' + roman(x,1) + '\' style=\'cursor: pointer; border: 1px dotted gold; background-image: URL(https://res.landsofhope.com/game/i/bv1.gif); width: 26px; height: 58px; background-repeat: no-repeat; background-position: top middle;\' valign=bottom><b>' + roman(x,1) + '</b></td>';
	}	
