...
getObj('Buttons').innerHTML = '<input type=hidden name=ItemID id=ItemID value=' + Infos[v].z + '>' + (InventoryItemID > 0 ? Adf2('', 'Apply poison', 'Poison') : '') + (Infos[v].t.indexOf('(#)') != -1 ? Adr('getObj(\'ItemID\').value = -' + Infos[v].z + ';getObj(\'poison\').submit()', 'Remove poison', 'Remove') : '') + Adr('window.top.loadwindow2(\'im4.asp?Test=' + Infos[v].z + '&Bonus=0&Material=\',300,300,\'iwindow\',\'' + Infos[v].t + '\');','Info','Info') + (TrapID > 0 ? Adr('window.top.loadwindow2(\'Sz.asp?Test=' + TrapID + '\',300,300,\'iwindow\',\'Poison Info\');','Poison Info','Other') : '');
}
