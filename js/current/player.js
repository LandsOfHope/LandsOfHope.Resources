...
{         
	...
	var tn = TabName(i);
	strTest += ("<td valign=bottom></td><td style='background-image: URL(https://res.landsofhope.com/game/pirate/piratetab.png); background-position: bottom; background-color: transparent; width:25px'><a class='tab' href='javascript:GoP(" + i + ");'>" + tn + "</a></td>")
	if (v >= 20) {
		strTest += "</tr><tr>";
		v = 0;
	}
...
var strTest = '';
strTest = "<td valign=bottom></td><td style='background-image: URL(https://res.landsofhope.com/game/pirate/piratetab.png); background-position: bottom; background-color: transparent; width:25px'><a class='tab' href=\"javascript: window.close();\" title=\"Close this window\">Close</a></td>";
