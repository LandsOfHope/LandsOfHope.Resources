...
function AdC(n, Names, Color, PictureID) {
	...
	document.write('<tr><td style=\'cursor: pointer\'><table align=center cellspacing=0 class="weakercell" cellpadding=1><tr><td class="menucell" title="' + Titles2 + '" style="width: 30px; color: ' + Color + '; background-color:' + Color + '" onmouseover="this.style.backgroundColor=\'' + BGCOLOR_S + '\';window.top.InfoTip(\'game/v/' + PictureID + '\', \'<b>' + Names + '</b><br>' + Titles2 + '\');" onmouseout="this.style.backgroundColor=\'' + Color + '\';"><img width=30 height=30 id=Bag' + n + ' src="https://lohcdn.com/game/v/' + (PictureID == '' || PictureID == '0' ? 'na.gif' : PictureID) + '" onclick="FBI(' + n + ',\'' + Names + '\');"></td></tr></table></td></tr>');
}