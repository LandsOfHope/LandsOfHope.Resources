...
document.write('<tr width="280" style="background-color: ' + bg + '"><td><table class="weakcell" cellpadding=0 cellspacing=0><tr><td width=32><img src="' + IPath + PictureID + '" align=left width=32 height=32></td><td width="100%" style="color: ' + Color + '; background-color: ' + bg + ';" valign=top><b>' +n + '</b>' + ctt + '</td><td valign=right>' + (window.top.SystemUser != 0 ? '<img src="https://res.landsofhope.com/game/icons/comment_delete.png" title="Delete comment" style="cursor: pointer;" class="xbtn" onclick="javascript:window.location.replace(\'?CharsAt=' + CharsAt + '&Type=' + Type2 + '&P=' + PageNo + '&P2=' + PageNo2 + '&D=' + v + '&Search=' + Search + '\');"><br>' : '') + (eok != 0 ? '<img src="https://res.landsofhope.com/game/icons/comment_edit.png" title="Edit comment" style="cursor: pointer;" class="xbtn" onclick="tinyMCE.get(\'postcm\').setContent(getObj(\'box' + v + '\').innerHTML); getObj(\'E\').value = ' + v + ';">' : '') + '</td></tr></table></td></tr>');
