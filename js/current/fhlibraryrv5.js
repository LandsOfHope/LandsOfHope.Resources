...
document.write('<tr  id="I' + IC + '" onmouseover="PC(' + IC + ')" onmouseout="RC(' + IC + ')"  onclick="DC(' + IC + ')" style="color: ' + Color + '"><td width=15><img width=15 height=15 src="' + IPath + (PictureID == '' || PictureID == '0' ? 'na.gif' : PictureID) + '"></td><td>' + Itty + '</td><td style="width: 16px;">' + (hm != 0 ? '<img src="https://res.landsofhope.com/game/i/mil.gif" width=14 height=14 title="Milkable">' : '') + '</td><td color="gold">' + (ep > 0 ? '$' : '') + '</td></tr>');

IC = IC + 1;
}

function newInfo(Color, rid, rc, Itty, PictureID, t, b, m, ep, hm) {
this.c = Color;
this.r = rid;
this.p = PictureID;
this.e = ep;
