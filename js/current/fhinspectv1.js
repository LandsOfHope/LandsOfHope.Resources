...
{         
	...
	var tn = TabName(i);
	strTest += ("<td valign=bottom></td><td style='background-image: URL(https://res.landsofhope.com/game/pirate/piratetab.png); background-position: bottom; background-color: transparent; width:100px' align=center><a class='tab' href='javascript:GoP(" + i + ");'>" + tn + "</a></td>")
	if (v >= 20) {
		strTest += "</tr><tr>";
		v = 0;
	}
...
var Color = VC;
document.write('<tr width="300"><td><img src="https://res.landsofhope.com/game/i/' + VIP + '" width=15 height=15></td><td width="170" c="' + Color + '" style="color: ' + Color + '; padding-left: 5px" class="specialcell">' + (VQ + ' * ') + VIN + '</td><td>' + window.top.PSGM(VV) + '</td></tr>');
}
