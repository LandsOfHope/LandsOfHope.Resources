...
document.write('<div width="42" height="42" style="padding: 1px; margin: 1px;float: left; " id="CI' + VC + '" onclick="DC5(' + VC + ')" onmouseover="PC5(' + VC + ');" onmouseout="RC(this);"><img width=40 height=40 src="https://res.landsofhope.com/game/v/' + PictureID + '"></div>');
VC = VC + 1;
}
...
Color = LITE;
document.write('<tr width="255"><td><img src=\'https://res.landsofhope.com/images/' + PictureID+ '\' alt=\'' + CharacterName + '\'></td><td width="205" style="color: ' + Color + '; padding-left: 5px; background-color: ' + BGCOLOR_S + '" valign=top>' + CharacterName  + '<br>Faction: <b>' + fv + '</b>' + (fb > 0 ? '<br>This Challenge: <i>' + fb + '</i>' : '') + '</td></tr>');
}
...
function PC5(v) {
window.top.InfoTip('https://res.landsofhope.com/game/v/' + Vessels[v].p, '<b>' + Vessels[v].VesselName + '</b>');
getObj('CI' + v).style.cursor = 'pointer';
getObj('CI' + v).style.backgroundColor=BGCOLOR_S
}
...
var Color = LITE;
document.write('<tr style="color:' + Color +'"><td width="40"><img src="https://res.landsofhope.com/game/i/' + tip + '"></td><td width="260" valign=top><b>' + tin + '</b><br><font id=tmagenta>' + ot + '</font></td><td>Rank ' + ts + '</td></tr>');
}
...
document.write('<tr style="color:' + Color +'"><td width="40"><img src="https://res.landsofhope.com/game/i/' + tip + '"></td><td width="160" valign=top><b>' + tin + '</b><br><i style=""color: cyan;"">' + (unlocked != 0 ? '' + tt : 'Cost: <b>' + cost + 'mc</b>') + '</i></b></td><td>' + (unlocked != 0 ? '' : '<a href="fhsocialbuy.asp?id=' + tid + '&CharsAt=' + CharsAt + '"><img src="https://res.landsofhope.com/images/buttons/d_buy.gif" border="0" alt="Buy Social Item!"></a>') + '</td></tr>');
}