...
function AM(ql, v, x,y, g, Named, Picture, CN, b, a, qr, qt) {
...
Infos[IC] = new newInfo(Color, ql, v, x,y, g, Named, Picture, CN, b, a, qr, qt);
...
function newInfo(Color, ql, v, x,y, g, Named, Picture, CN, b, a, qr, qt) {
this.c = Color;
this.g = g;
this.p = Picture;
this.a = a;
