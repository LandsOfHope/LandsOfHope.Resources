...
function DC(v) {
getObj('Stuff2').innerHTML = '<b>' + Infos[v].i + '</b><br>Cost: ' + window.top.BSGM(Infos[v].v) + '<br>' + Adr('if (Processing ==0) {Processing = 1; window.location.replace(\'?CharsAt=' + CharsAt + '&Pet=' + Pet + '&ItemID=' +Infos[v].value + '\');}','Train Pet','Train Pet') + Adr('window.top.loadwindow2(\'skz.asp?test=' + Math.abs(Infos[v].value) + '\',300,300,\'iwindow\',\'' + Infos[v].i + '\');','Info','Info') 
