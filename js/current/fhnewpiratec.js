...
{         
	...
	var tn = TabName(i);
	strTest += ("<td valign=bottom></td><td style='background-image: URL(https://res.landsofhope.com/game/pirate/piratetab.png); background-position: bottom; background-color: transparent; width:100px;' align=center><a class='tab' href='javascript:GoP(" + i + ");' style='" + (i < PageNo ? "color: #66ff66;" : (i == PageNo ? "color: yellow;" : "")) + "' title='" + tn + "'>" + tn + "</a></td>")
	if (v >= 20) {
		strTest += "</tr><tr>";
		v = 0;
	}
...
var strTest = '';
strTest = "<td valign=bottom></td><td style='background-image: URL(https://res.landsofhope.com/game/pirate/piratetab.png); background-position: bottom; background-color: transparent; width:100px' align=center><a class='tab' href=\"javascript: window.top.hidePopWin(true);\" title=\"Close this window\">Close</a></td>";
...
if (getObj('Results') != undefined) {
	...
	getObj('Results').innerHTML = '<table class=\'specialcell\' cellpadding=1 cellspacing=1><tr><td colspan=3><b>Checklist</b></td></tr><tr><td><b>Step 1</b></td><td>Profession ' + (lastp3 != '' ? '' + lastp3 + '</td><td><img src="https://res.landsofhope.com/game/icons/tick.png" alt="Complete">' : '</td><td><img src="https://res.landsofhope.com/game/icons/cross.png" alt="Incomplete">') + '</td></tr><tr><td><b>Step 2</b></td><td>Sex ' + (getObj('Sex').value != '' ? '' + (getObj('Sex').value == 'M' ? 'Male' : 'Female') + '</td><td><img src="https://res.landsofhope.com/game/icons/tick.png" alt="Complete">' : '</td><td><img src="https://res.landsofhope.com/game/icons/cross.png" alt="Incomplete">') + '</td></tr><tr><td></td><td>Picture' + (getObj('thepic').value != '' ? '</td><td><img src="https://res.landsofhope.com/game/icons/tick.png" alt="Complete">' : '</td><td><img src="https://res.landsofhope.com/game/icons/cross.png" alt="Incomplete">') + '</td></tr><tr><tr><td></td><td>Character Name' + (getObj('CharacterName').value != '' ? '</td><td><img src="https://res.landsofhope.com/game/icons/tick.png" alt="Complete">' : '</td><td><img src="https://res.landsofhope.com/game/icons/cross.png" alt="Incomplete">') + '</td></tr><tr><td><b>Step 3</b></td><td>Vessel Name' + (getObj('VesselName').value != '' ? '</td><td><img src="https://res.landsofhope.com/game/icons/tick.png" alt="Complete">' : '</td><td><img src="https://res.landsofhope.com/game/icons/cross.png" alt="Incomplete">') + '</td></tr><tr><td></td><td>Bonus' + (getObj('Bonus').value != -1 ? '</td><td><img src="https://res.landsofhope.com/game/icons/tick.png" alt="Complete">' : '</td><td><img src="https://res.landsofhope.com/game/icons/cross.png" alt="Incomplete">') + '</td></tr><tr></table>';
	if (PageNo == 4) {
...
var y = 0;
for (y = 0; y < counter; y++) {
	strout = strout + '<td><table height=180><tr><td width=120 id="p' + y + '" onclick="DC(' + y + ')" onmouseover="PC(this)" onmouseout="RC(this)" style=\'color: white\' title=\'Pick a ' + Profs[y][2] + '\'><table><tr><td><img src=\'https://res.landsofhope.com/images/' + Profs[y][1] + '\' alt=\'Click to pick ' + Profs[y][2] + '\'></td><td><img src=\'https://res.landsofhope.com/game/icons/info.png\'><a href=\'pesd.asp?CharsAt=' + Profs[y][0] + '\' target=\'_new\'>Info</a></td></tr></table></td></tr><tr><td class=\'specialcell\'><div style=\'height: 130; overflow: auto\'>' + Profs[y][4] + '</div></td></tr></table></td>';
}
