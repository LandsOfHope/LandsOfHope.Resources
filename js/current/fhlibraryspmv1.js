...
function DC(v) {
	...
	getObj('Buttons').innerHTML = Adr('window.location.replace(\'fhlibraryspm2.asp?CharsAt=' + Infos[v].s + '&PetID=' + PetID + '&SN=' + Infos[v].i  + '\');', 'View all spells from the ' + Infos[v].i + ' spell line', 'View');
}
