...
function GetAbilities(f) {
	...
	if (Fighters[f].s == Side && f == 0) {
		retVal = retVal + '<div class="btn" onclick="FAC(' + f + ', -10)" style="float: left; width: 34px; height: 40px; background-image: URL(https://res.landsofhope.com/game/s/meat.png); background-repeat: no-repeat; background-position: top center;" title="Consume Healing item" onmouseover="PC3(this)" onmouseout="RC2(this)" align=bottom>&nbsp;</div>'
		retVal = retVal + '<div class="btn" onclick="FAC(' + f + ', -20)" style="float: left; width: 34px; height: 40px; background-image: URL(https://res.landsofhope.com/game/s/potion.png); background-repeat: no-repeat; background-position: top center;" title="Consume Power item" onmouseover="PC3(this)" onmouseout="RC2(this)" align=bottom>&nbsp;</div>'
