...
document.write(`<script src="${CDN_RESOURCES_URL_formatting}/js/current/tooltip.js" language="JavaScript"></script>`);
document.write(`<script src="${CDN_RESOURCES_URL_formatting}/js/current/keystroke.js" language="JavaScript"></script>`);
document.write(`<script src="${CDN_RESOURCES_URL_formatting}/js/current/prompts.js" language="JavaScript"></script>`);
...
function PFormMoney(fin, mmin) {
	...
	return `<img src=\"${CDN_RESOURCES_URL_formatting}/game/pirate/c4.png\"><input title=\"Doubloons\" name=cpd${fin} id=cpd${fin} value=${m} size=3 maxlength=10 style=\"width: 30px;\" onkeypress=\"return fxkp(event);\" onpaste=\"event.returnValue = false;\" onkeyup=\"CalcM('${fin}', this)\">`;
}
...
function DrawImage(imgpath, imgw, imgh) {
	return `<img src=\'${imgpath}\' onerror='this.src="${CDN_RESOURCES_URL_formatting}/na.gif"'>`;
}
