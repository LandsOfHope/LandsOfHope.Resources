...
function AB(PictureID, ItemName, ItemID, Color, h, l, x, y, v, g, c, d, hd, rl, rt, nd, lsr, pea, hap) {
	...
	var strl = (Infos[v].lsr == 0 ? (Infos[v].rl > 0 ? 'Rooms: ' + Infos[v].rt + ' of ' + Infos[v].rl : '') : '<table cellpadding=1 cellspacing=0 class="weakercell"><tr><td width=\'33%\'>' + (Infos[v].lsr != 0 ? '<img src=\'https://lohcdn.com/game/icons/chart_curve.png\' title=\'' + Infos[v].lsr + 'rating\'>: ' + Infos[v].lsr : '') + '</td><td width=\'33%\' align=center>' + GetHap(hap) + '</td><td width=\'33%\'>' + (Infos[v].pea != 0 ? '<img src=\'https://lohcdn.com/game/icons/user_green.png\' title=\'' + Infos[v].pea + 'peasants\'>: ' + Infos[v].pea : '') + '</td></tr><tr><td colspan=3><img src=\'https://lohcdn.com/game/icons/coins.png\' title=\'Weekly income\'>: ' + window.top.BSGM(income) + '</td></tr></table>');
...
function GetHap(h) {
	var strh = '';
	if (h < 30) {
		strh = '<img src=\'https://lohcdn.com/game/icons/emoticon_unhappy.png\' title=\'' + h + '% happy\'>';
	} else if (h < 70) {
		strh = '<img src=\'https://lohcdn.com/game/icons/emoticon_waii.png\' title=\'' + h + '% happy\'>';
	} else {
		strh = '<img src=\'https://lohcdn.com/game/icons/emoticon_happy.png\' title=\'' + h + '% happy\'>';
	}
	return strh;
}
