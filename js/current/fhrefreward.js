...
function DC(v) {
	getObj('Stuff2').innerHTML = '<b>' + Infos[v].s + '</b><Br>Points: ' + Infos[v].d2 + '<img src="https://res.landsofhope.com/game/icons/star.png" title="' + Infos[v].d2 + ' Paid referrals"> ' + Infos[v].d1 + '<img src="https://res.landsofhope.com/game/icons/status_offline.png" title="' + Infos[v].d1 + ' Standard referrals">';
...
function PC(v) {
	window.top.InfoTip('' + IPath + Infos[v].p, '<b>' + Infos[v].s + '</b><Br>Points: ' + Infos[v].d2 + '<img src="https://res.landsofhope.com/game/icons/star.png" title="' + Infos[v].d2 + ' Paid referrals"> ' + Infos[v].d1 + '<img src="https://res.landsofhope.com/game/icons/status_offline.png" title="' + Infos[v].d1 + ' Standard referrals">');
...
for (y = 0; y < Infos.length; y++) {
	if (Infos[y].h == ShopNum) {
		strout = strout + '<div id="I' + y + '" onmouseover="PC(' + y + ');" onmouseout="RC(' + y + ');" title="' + Infos[y].s + '"  onclick="DC(' + y + ');" style="float: left; padding: 1px; margin: 1px; border: 1px dotted ' + Infos[y].c + '; width: 70px; height: 40px; background-color:' + Infos[y].c + ';" valign=bottom><table class="weakercell" style="filter: Glow(Color=#000000, Strength=1);" width="70px" height="40"><tr height="40"><td width="40"><img src="' + IPath + Infos[y].p + '" width=40 height=40></td><td width="30">' + Infos[y].d2 + '<img src="https://res.landsofhope.com/game/icons/star.png" title="' + Infos[y].d2 + ' Paid referrals"> ' + Infos[y].d1 + '<img src="https://res.landsofhope.com/game/icons/status_offline.png" title="' + Infos[y].d1 + ' Standard referrals"></td></tr></table></div>';	}
}
