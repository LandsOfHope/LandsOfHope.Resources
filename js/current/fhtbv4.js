...
function AvC(Color, z, s, u, l, a, i, v, m, PictureID, Itty) {
	...
	// p="' + PictureID + '"  z=' + z + ' a="' + a + '"
	document.write('<tr id="I' + IC + '" onmouseover="PC(' + IC + ')" onmouseout="RC(' + IC + ')"  onclick="DC(' + IC + ')"><td><img width=15 height=15 src="' + IPath + (PictureID == '' || PictureID == '0' ? 'na.gif' : PictureID) + '"></td><td width="300" style="color: ' + Color + '; padding-left: 5px">' + Itty + '</td><td><input type=checkbox id=IID name=IID value="' + z + '" style="width: 12px; height: 12px"></td></tr>');
	IC = IC + 1;
}
