...
function DC(v) {
	...
	getObj('Buttons').innerHTML = '<' + strClicky3 + ' onclick="if (Processing == 0) {Processing = 1; window.location.replace(\'?CharsAt2=' + Infos[v].v + '&aok=' + Infos[v].sv + '&P=' + PageNo + '\'); this.disabled=true;}" style=\'width: 85\'>Make</button>';
}
