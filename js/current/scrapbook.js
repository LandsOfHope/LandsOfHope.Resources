...
function DC(v) {
	if (Infos[v].st == 0 || Infos[v].st == 5) {
		getObj("Stuff").style.backgroundImage = 'URL(https://res.landsofhope.com/images/pet.png)';
	} else if (Infos[v].st == 1) {
		getObj("Stuff").style.backgroundImage = 'URL(https://res.landsofhope.com/images/pet.png)';
	} else if (Infos[v].st == 2 || Infos[v].st == 7) {
		getObj("Stuff").style.backgroundImage = 'URL(https://res.landsofhope.com/images/player.png)';
	} else if (Infos[v].st == 3) {
		getObj("Stuff").style.backgroundImage = 'URL(https://res.landsofhope.com/images/building.png)';
	} else if (Infos[v].st == 4) {
		getObj("Stuff").style.backgroundImage = 'URL(https://res.landsofhope.com/images/item.png)';
	}
...
function DrawHeaders(hn) {
	document.write("<table cellpadding=0 cellspacing=0 border=0 height='30px'><tr><td width=240 class=title>" + hn + "</td><td valign=bottom><img src='https://res.landsofhope.com/images/tableft.gif' border=0></td><td style='background-image: URL(https://res.landsofhope.com/images/tab.gif); background-position: bottom; background-color: transparent; width:25px'><a class='tab' href='javascript:ShowTab(0);'>All</a></td><td valign=bottom><img src='https://res.landsofhope.com/images/tabjoin.gif' border=0></td><td style='background-image: URL(https://res.landsofhope.com/images/tab.gif); background-position: bottom; background-color: transparent; width:35px'><a class='tab' href='javascript:ShowTab(1);'>Items</a></td><td valign=bottom><img src='https://res.landsofhope.com/images/tabjoin.gif' border=0></td><td style='background-image: URL(https://res.landsofhope.com/images/tab.gif); background-color: transparent; background-position: bottom; width:75px'><a class='tab' href='javascript:ShowTab(2);'>Characters</a></td><td valign=bottom><img src='https://res.landsofhope.com/images/tabjoin.gif' border=0></td><td style='background-image: URL(https://res.landsofhope.com/images/tab.gif); background-position: bottom; background-color: transparent; width:45px'><a class='tab' href='javascript:ShowTab(7);'>Friends</a></td><td valign=bottom><img src='https://res.landsofhope.com/images/tabjoin.gif' border=0></td><td style='background-image: URL(https://res.landsofhope.com/images/tab.gif); background-color: transparent; background-position: bottom; width:75px'><a class='tab' href='javascript:ShowTab(5);'>Screenshots</a></td><td valign=bottom><img src='https://res.landsofhope.com/images/tabright.gif' border=0></td></tr></table>");
}
