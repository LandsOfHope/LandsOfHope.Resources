...
function DC(v) {
	getObj('Stuff2').innerHTML = "<b>" + Infos[v].n + "</b><br><input type='hidden' id=g name=g value='" + g + "'><input type='hidden' id=IID name=IID value='" + Infos[v].v + "'><input type=hidden id=ImgSource name=ImgSource value=\'' + Infos[v].p + '\'>" + DrawImages(Infos[v].p);
