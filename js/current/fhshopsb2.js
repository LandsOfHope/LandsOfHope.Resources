...
function DC(v) {
	getObj('Stuff2').innerHTML = '<b>' + Infos[v].i + '</b><br>Level: ' + Infos[v].v + '<br>' + Adr('if (Processing ==0) {Processing = 1; window.location.replace(\'fhshopsb3.asp?CharsAt=' + CharsAt + '&Pet=' + Infos[v].value + '\');}', 'Select ' + Infos[v].i, 'Select');
