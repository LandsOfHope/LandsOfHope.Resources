...
function GS(how, stuff) {
	if (Processing == 0) {
		Processing = 1;
		window.location.replace('fhtifa.asp?Type=' + how + '&SN=' + SN + '&MapID=' + MapID + '&P=' + PageNo + '&Who=' + Infos[LastV].t + '&CharsAt2=' + stuff);
	}
}

function GoP(PageNo) {
	window.location.replace('?SN=' + SN + '&MapID=' + MapID + '&P=' + PageNo + '');
}
