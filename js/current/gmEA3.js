...
function DC(v) {
	...
	getObj('Buttons').innerHTML = Adr('window.location.replace(\'gmEA.asp?Mask=' + Mask + '&CharsAt=' + Infos[v].d + '\');', 'Account', 'Account') + Adr('window.location.replace(\'gmEA2.asp?Mask=' + Mask + '&CharsAt=' + Infos[v].d + '\');', 'Billing', 'Billing') + Adr('conf(\'Account Name:\', \'' + Infos[v].n + '\', \'gmEA3.asp?Mask=' + Mask + '&Action=1&CharsAt=' + Infos[v].d + '&Name=\');', 'Name', 'Name') + Adr('conf(\'Account Password:\', \'' + Infos[v].p + '\', \'gmEA3.asp?Mask=' + Mask + '&Action=2&CharsAt=' + Infos[v].d + '&Name=\');', 'Password', 'Password') + Adr('conf(\'Date of Birth (mm/dd/yyyy):\', \'' + Infos[v].dob + '\', \'gmEA3.asp?Mask=' + Mask + '&Action=4&CharsAt=' + Infos[v].d + '&Name=\');', 'Date of Birth', 'Date of Birth') + Adr('conf(\'2 Digit Country Code:\', \'' + Infos[v].cc + '\', \'gmEA3.asp?Mask=' + Mask + '&Action=5&CharsAt=' + Infos[v].d + '&Name=\');', 'Country', 'Country') + Adr('gowin(\'gmEAN.asp?CharsAt=' + Infos[v].d + '\', 615, 200,50, \'Notices\')', 'Notices', 'Notices');
}
