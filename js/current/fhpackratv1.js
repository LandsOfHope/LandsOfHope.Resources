...
function GoP(PageNo) {
	window.location.replace('?P=' + PageNo + '&search=' + s);
} 
...
function DC(v) {
	...
	getObj('Buttons').innerHTML = Adr('window.location.replace(\'fhpackrat.asp?ItemID=' + Infos[v].InventoryItemID +'&search=' + s + '\');','Retrieve','Retrieve') + Adr('window.top.loadwindow2(\'im4.asp?Test=' + Infos[v].InventoryItemID + '&Bonus=0&Material=\',300,300,\'iwindow\',\'' + Infos[v].ItemName + '\');','Info','Info');
}
