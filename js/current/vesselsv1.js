...
function AvC(Color, z, Itty, vp, vt) {
	...
	document.write(`<tr width="160"><td><img src="${CDN_RESOURCES_URL}/game/v/${vp}" width=15 height=15></td><td width="145" onclick="DC(${z})" t="${Itty}" onmouseover="PC(this)" onmouseout="RC(this)" style="padding-left: 5px;" class="specialcell"><b style="color: ${Color};">${Itty}</b></td></tr>`);
	Countx = Countx + 1;
}
...
function DrawFooters() {
	var strTest = '';
	strTest = `<td valign=bottom></td><td style='background-image: URL(${CDN_RESOURCES_URL}/game/pirate/piratetab.png); background-position: bottom; background-color: transparent; width:100px' align=center><a class='tab' href=\"javascript:window.top.closeme('iwindow');\">Close</a></td>`;
