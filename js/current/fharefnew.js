...
PictureID = 'https://res.landsofhope.com/game/' + PictureID;

counter = counter + 1
var bg = 'color1'
if ((counter / 2) == Math.round(counter / 2)) {bg = 'color2'}

document.write('<tr class="' + bg + '" style="padding-left: 5px;"><td width=\'300\'><b style="color: ' +  Color + ';">' + Itty + '</b><br>' + d + '</td><td width=\'80\'>' + points2 + '<img src="https://res.landsofhope.com/game/icons/star.png" title="' + points2 + ' Paid referrals"> ' + points + '<img src="https://res.landsofhope.com/game/icons/status_offline.png" title="' + points + ' Standard referrals"></td><td>' + (rgp >= points2 && rp >= points ? Adr('BuyItem(' + ItemID + ');','Buy ' + Itty,'Buy') : '') + '</td></tr>');
}
