...
function GoP(PageNo) {
	window.location.replace('?P=' + PageNo + '&E=' + E + '&Type=' + MT);
}
...
function DC(v) {
	...
	getObj('Buttons').innerHTML = '<' + strClicky + ' onclick="if (Processing == 0) {window.location.replace(\'fhlibraryilex.asp?Type=' + Infos[v].m + '&E=' + E + '\')}" style=\'width: 65\'>View</button>';
}
