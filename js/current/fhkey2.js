...
function Plt(IType, Named, Picture, X, Y) {
	...
	document.write('<img src=\'' + Picture + '\'  id=\'SM' + MC + '\' style=\'position: absolute; width: 10; height: 10; cursor: pointer;' + (Special == 1 ? 'border: 1px solid gold; ' : 'border: 1px solid white; ') + 'left: ' + (((X - OX) * 12) - 8) + '; top: ' + (((Y - OY) * 12) + 10) + ';\' onclick="Go(' + X + ',' + Y + ')" OnMouseOver="smy(' + MC + ');">')
...
function BuildSearch2() {
	document.write('<div style=\'height: 300; overflow: auto\'><table cellpadding=1 cellspacing=1 class=\'itemtext\' height=295 id=Yoyo>' + strYoyo + '<tr height=\'100%\'><td></td><tr></table></div>');
}
