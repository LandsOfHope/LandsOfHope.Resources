...
var gPostBack = null;
const CDN_RESOURCES_URL_submodal = new URL(document.currentScript.src).origin;
...
function initPopUp() {
	...
	popcont.innerHTML = `<div id="popupInner"><table width="100%" cellpadding=0 cellspacing=0 class="navborderx" id="popupTitleBar"><tr style="height: 22px;"><td class="menul">&nbsp;&nbsp;&nbsp;</td><td class="title" width="100%" id="popupTitle"></td><td><img src="${CDN_RESOURCES_URL_submodal}/game/icons/cancel.png" border=0 onclick="hidePopWin(false);" id="popCloseBox" style="cursor: pointer;"></td><td class="menur">&nbsp;&nbsp;&nbsp;</td></tr></table><iframe src="${gDefaultPage}" style="width:100%;height:100%;background-color:transparent;" scrolling="auto" frameborder="0" allowtransparency="true" id="popupFrame" name="popupFrame" width="100%" height="100%"></iframe></div>`;
