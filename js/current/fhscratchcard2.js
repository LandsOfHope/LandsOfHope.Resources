...
function AM(Picture, Named) {
	...
	document.write(`<td id="IP${IC}"><img id="I${IC}" src=\'${CDN_RESOURCES_URL}/images/scratch5.gif\' style=\'cursor: pointer; background-image:URL(${CDN_RESOURCES_URL}/game/${Picture});\' title=\'Scratch me!\' width=\'100px\' height=\'100px\' onclick=\'Scratch(${IC})\'></td>`);
	count = count + 1
	if (count == 4) {
		document.write('</tr>');
		count = 1;
